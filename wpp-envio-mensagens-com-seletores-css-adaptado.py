...
# Localiza a caixa de busca de contatos usando seletor CSS
...
# Envia mensagem de texto usando seletor CSS
...
# Clica no botão de enviar usando seletor CSS
send_button = driver.find_element(By.CSS_SELECTOR, 'button[data-testid="compose-btn-send"]')
send_button.click()
time.sleep(2)

# Envio de arquivo PDF
# 1. Clica no ícone de anexo usando seletor CSS
attachment_button = driver.find_element(By.CSS_SELECTOR, 'div[title="Anexar"]')
attachment_button.click()
time.sleep(random.uniform(1, 2))

# 2. Seleciona o input de arquivo usando seletor CSS
...
# 3. Clica no botão de envio do PDF usando seletor CSS
send_pdf_button = driver.find_element(By.CSS_SELECTOR, 'span[data-icon="send"]')
